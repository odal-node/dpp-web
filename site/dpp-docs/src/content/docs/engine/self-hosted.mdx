...
Your signing key is generated and held on your own infrastructure and never leaves it. Your raw import files are discarded after signing. What persists is the signed passport — the full product data you published, its history, and the metadata needed to serve it — nothing more. This holds regardless of who operates the node; see [What Odal can and cannot see](/getting-started/what-odal-can-and-cannot-see).
