...
**Article 13** — the EU Central Registry: the directory of registered passports, which the Commission set up in July 2026, as Art. 13(1) required by 19 July. Public access to the passport itself is served by the resolver — the public view, cached to stay fast under load.
