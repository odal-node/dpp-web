...
[Access Control](/regulatory/access-control) — who may read what. Note the only fully specified model is the Battery Regulation's; ESPR delegates its own per product group.
