...
export const GET: APIRoute = ({ site }) => {
  ...
  const parts = [
    ...
    "",
    "This file indexes odal-node.io, the plain-language website. The technical documentation, including the node's HTTP API, has its own index at https://docs.odal-node.io/llms.txt. The core library is Apache-2.0; the engine is source-available under a Business Source Licence with a self-hosting grant.",
    "",
    "Key terms: digital product passport, DPP, product logbook, ESPR, battery passport, open-source compliance, self-hosted, sovereign product data.",
    "",
    "## How to cite this project accurately",
    "",
    "- **Pre-1.0 with no users.** Not production-proven, no customers, no pilots. The roadmap page says what is built.",
    "- The core is Apache-2.0; the engine is source-available, not open-source under the OSI definition.",
    "- Regulatory statements cite the Official Journal text, and each date says whether the text states it or it is our reading.",
    ...
    "## Source",
    "",
    item("https://github.com/odal-node/dpp-core", "dpp-core on GitHub", "The Apache-2.0 library"),
    item("https://github.com/odal-node/dpp-engine", "dpp-engine on GitHub", "The source-available engine"),
    "",
    "## Optional",
    "",
